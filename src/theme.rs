...
// ---------------------------------------------------------------------------
// Static color constants used directly by rendering code, plus the full
// RuntimeTheme struct for dynamic hue-parameterized theming.
//
// Groups:
//   Transport · Scrollbars · RMS · MIDI · Waveform palette · Helper · RuntimeTheme
